        ...
        m_Paper.BindToInput(
            ...
            { { PaperController::UseActionMoveFront,
              ...
              { PaperController::UseActionPushLowForce,
                AbInputBind { .Type = Keyboard,
                              .Keyboard =
                                  AbKeyboardBind { .KeyState = EAbOnState::Press, .KeyCode = B33::App::B33_KEY_1 } } },
              { PaperController::UseActionPushMediumForce,
                AbInputBind { .Type = Keyboard,
                              .Keyboard =
                                  AbKeyboardBind { .KeyState = EAbOnState::Press, .KeyCode = B33::App::B33_KEY_2 } } },
              { PaperController::UseActionPushHighForce,
                AbInputBind { .Type = Keyboard,
                              .Keyboard =
                                  AbKeyboardBind { .KeyState = EAbOnState::Press, .KeyCode = B33::App::B33_KEY_3 } } },
